    ...
    private val storageResultLauncher : ActivityResultLauncher<String> =
       registerForActivityResult(
           ...
           if (isGranted) {
               Toast.makeText(
                   this,
                   "Permission granted for external Storage", Toast.LENGTH_SHORT
               ).show()
...
//        val ibRedu : ImageButton = findViewById(R.id.ib_redu)
//        ibRedu.setOnClickListener{
//            drawingView?.onClickRedu()
//        }
    }
